...
Page({
  ...
  add:function(e){
    ...
    getApp().globalData.teamChoose=e.currentTarget.dataset.lockerid,
    getApp().globalData.teamTag=e.currentTarget.dataset.lockerid.id,
  ...
  onSubmit:function(){
    wx.navigateTo({
        url: '../../../makeTeamPackage/pages/recommandTeam/recommandTeam',
  ...
  close:function(){
    ...
    //this.data.haschoose="",
    //this.data.chooseTag=[],
    app.globalData.teamChoose=[],
    app.globalData.teamTag=[],
    this.data.choose1="",
    // this.data.delete="",
